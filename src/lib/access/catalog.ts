import { operatingHoursCondition } from "@/lib/access/conditions/operating-hours";
...
const CONDITIONS: Record<string, AccessCondition> = {
  [operatingHoursCondition.id]: operatingHoursCondition,
...
export const ROUTE_CONDITIONS: Record<string, string[]> = {
  [CHAT_PATH]: [operatingHoursCondition.id, pauseCondition.id],
};
